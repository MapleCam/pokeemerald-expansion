...
#define MAP_LITTLEROOT_DEV_ROUTE (57 | (0 << 8))
...
#define MAP_LITTLEROOT_DEV_HOUSE                 (5 | (1 << 8))
#define MAP_LITTLEROOT_DEV_HOUSE_A2              (6 | (1 << 8))
...
#define MAP_DEV_CAVE_LITTLEROOT_ROUTE                (108 | (24 << 8))
